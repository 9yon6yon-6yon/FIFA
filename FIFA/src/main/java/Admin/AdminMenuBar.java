...
public class AdminMenuBar  {
    public AdminMenuBar(){
        ...
        menu[1] = new Menu("View");
        menu[2] = new Menu("Edit");
        menu[3] = new Menu("Post News");
        ...
        menuItems[2] = new MenuItem("View Profile");
        menuItems[3] = new MenuItem("Edit Match Tree");
        menuItems[4] = new MenuItem("Buy Tickets");
        menuItems[5] = new MenuItem("BMI");
        menuItems[6] = new MenuItem("Edit Groups");
        menuItems[7] = new MenuItem("Edit Players");
        menuItems[8] = new MenuItem("Edit Group Matches");
        menuItems[9] = new MenuItem(" Edit Match score");
        menuItems[10] = new MenuItem("Stream Live");
        menuItems[11] = new MenuItem("Upload to Feed");
